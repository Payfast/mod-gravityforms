...
class GFPayFastData{
    ...
    public static function update_table(){
        global $wpdb;
        $table_name = self::get_payfast_table_name();
    ...
    public static function get_payfast_table_name(){
        global $wpdb;
        return $wpdb->prefix . "rg_payfast";
    }
    ...
    public static function get_feed_by_form($form_id, $only_active = false){
        ...
        return apply_filters("gform_payfast_get_feeds_{$form_id}", apply_filters('gform_payfast_get_feeds', $results, $form_id), $form_id);
    }
    ...
    public static function drop_tables(){
        global $wpdb;
        $wpdb->query("DROP TABLE IF EXISTS " . self::get_payfast_table_name());
    }

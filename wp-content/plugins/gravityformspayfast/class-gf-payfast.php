...
class GFPayFast extends GFPaymentAddOn 
{
    ...
    //    $trial_period     = array(
    //        'name'    => 'trialPeriod',
    //        'label'   => __( 'Trial Period', 'gravityformspayfast' ),
    //        'type'    => 'trial_period',
    ...
    //        'name'       => 'recurringRetry',
    //        'label'      => __( 'Recurring Retry', 'gravityformspayfast' ),
    //        'type'       => 'checkbox',
    //        'horizontal' => true,
    //        'choices'    => array( array( 'label' => __( 'Try to bill again after failed attempt.', 'gravityformspayfast' ), 'name' => 'recurringRetry', 'value' => '1' ) ),
    //        'tooltip'    => '<h6>' . __( 'Recurring Retry', 'gravityformspayfast' ) . '</h6>' . __( 'Turn on or off whether to try to bill again after failed attempt.', 'gravityformspayfast' )
    //    );
    ...
    //    $page_style = ! empty( $feed['meta']['pageStyle'] ) ? '&page_style=' . urlencode( $feed['meta']['pageStyle'] ) : '';
       ...
       $return_mode = '2';
        ...
        $merchant_id = $feed['meta']['mode'] == 'production' ? $feed['meta']['payfastMerchantId'] : '10000100';
        $merchant_key = $feed['meta']['mode'] == 'production' ? $feed['meta']['payfastMerchantKey'] : '46f0cd694581a';
    ...
    private function get_payfast_feed_by_entry( $entry_id )
    {
